...
export default {
  ...
  // Suche (Issue #45)
  "filtern · Enter: ab hier suchen": "filter · Enter: search from here",
  "Suche": "Search",
  "Inhalt": "Content",
  "im Inhalt suchen (Textdateien)": "search in content (text files)",
  "Suche abbrechen": "Cancel search",
  "ab hier rekursiv suchen": "search recursively from here",
  "Suche leeren": "Clear search",
  "sucht „{0}“ …": "searching “{0}” …",
  "{0} Treffer für „{1}“": "{0} hits for “{1}”",
  "im Inhalt": "in content",
  "gekürzt": "truncated",
  "keine Treffer": "no hits",
  "zum Ordner springen": "jump to folder",
  "abgebrochen": "aborted",
  "nichts passt zu „{0}“ — Enter sucht ab hier rekursiv":
    "nothing matches “{0}” — Enter searches recursively from here",
  "leer": "empty",
